	...
	private keywords = [
		...
		,{
			...
			,clarification: [
				...
				,'<strong>When Recruited: Send This Undercover</strong> mean you get the Hero\'s normal recruit cost, put it in your Victory Pile worth 1VP and refill that HQ space with a card from the Hero Deck.'
